...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None, use_lmdb=False, resume=None):
...
def main():
    ...
    parser.add_argument('--script', type=str, default='diffusiontrack', help='Name of the train script.')
    parser.add_argument('--config', type=str,  default='diffusiontrack_b256_got', help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default='./save', help='the directory to save checkpoints and logs')
    parser.add_argument('--seed', type=int, default=None, help='seed for random numbers')
    parser.add_argument('--use_lmdb', type=int, choices=[0, 1], default=0)  # whether datasets are in lmdb format
    parser.add_argument('--resume', type=str, default=None, help='the directory to save checkpoints and logs')
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 use_lmdb=args.use_lmdb, resume= args.resume)
