...
from lib.models.diffusiontrack_vit import build_diffusiontrack_vit
from lib.test.tracker.seqtrack_utils import Preprocessor
from lib.utils.box_ops import clip_box
import numpy as np


class DIFFUSIONTRACK_VIT(BaseTracker):
    def __init__(self, params, dataset_name):
        super(DIFFUSIONTRACK_VIT, self).__init__(params)
        network = build_diffusiontrack_vit(params.cfg)
    ...
    def track(self, image, info: dict = None):
        ...
        # run the decoder
        with torch.no_grad():
            out_dict = self.network.inference_decoder(image_lists=images_list)
        ...
        if self.debug == 1:
           ...
           # print(str(self.state))
            ...
            #cv2.rectangle(image_BGR, (int(20),int(23)), (int(50),int(50)), color=(0,0,255), thickness=2)
