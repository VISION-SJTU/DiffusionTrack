...
class DynamicHead(nn.Module):
    ...
    def __init__(self, cfg, roi_input_shape):
        ...
        # Build heads.
        # self.iteration_head =  cfg.MODEL.HEAD.NUM_ITERATION
        num_classes = cfg.MODEL.HEAD.NUM_CLASSES
        d_model = cfg.MODEL.HEAD.HIDDEN_DIM
        dim_feedforward = cfg.MODEL.HEAD.DIM_FEEDFORWARD
        nhead = cfg.MODEL.HEAD.NHEADS
        ...
        self.head_divide = cfg.MODEL.HEAD.DIVIDE
        self.return_intermediate = True  # cfg.MODEL.DiffusionDet.DEEP_SUPERVISION
        ...
        prior_prob = cfg.MODEL.HEAD.PRIOR_PROB
    ...
    def _init_box_pooler(cfg, input_shape):
        ...
        # in_features = cfg.MODEL.ROI_BOX_HEAD.IN_FEATURES
        pooler_resolution = cfg.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION
        pooler_scales = [1.0 / input_shape[0]]
    ...
    def forward(self, features, init_bboxes, t, init_features):
        ...
        if len(features.shape) == 3:
            ...
            N_size = int(N2 ** 0.5)
            features_list = [features.reshape(b, N_size, -1, C).permute(0, 3, 1, 2)]
        ...
        if self.return_intermediate:
            inter_pred_bboxes.append(bboxes)

        for head_idx, rcnn_head in enumerate(self.head_series):
            class_logits, pred_bboxes, proposal_features = rcnn_head(features_list, bboxes, proposal_features,
        ...
        if self.return_intermediate:
            return torch.stack(inter_class_logits), torch.stack(inter_pred_bboxes), bbox_history

        return class_logits[None], pred_bboxes[None], bbox_history
...
class RCNNHead(nn.Module):
    ...
    def __init__(self, cfg, d_model, num_classes, dim_feedforward=2048, nhead=8, dropout=0.1, activation="relu",
        ...
        # cls.
        num_cls = cfg.MODEL.HEAD.NUM_CLS
        cls_module = list()
        ...
        # reg.
        num_reg = cfg.MODEL.HEAD.NUM_REG
        reg_module = list()
