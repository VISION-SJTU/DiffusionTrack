...
cfg.MODEL.STRIDE = 16  # the input feature to decoder. x, xz, or token
...
cfg.MODEL.HEAD.DIM_FEEDFORWARD = 2048
cfg.MODEL.HEAD.NHEADS = 8
cfg.MODEL.HEAD.DROPOUT = 0.1
cfg.MODEL.HEAD.ACTIVATION = 'relu'
cfg.MODEL.HEAD.NUM_HEADS = 6
cfg.MODEL.HEAD.NUM_PROPOSALS = 50
cfg.MODEL.HEAD.HIDDEN_DIM = 256
cfg.MODEL.HEAD.NUM_ITERATION = 1

cfg.MODEL.HEAD.ENCODER_FEATURE = [3, 7, 11]
cfg.MODEL.HEAD.NUM_CLS = 1
cfg.MODEL.HEAD.NUM_REG = 3
cfg.MODEL.HEAD.PRIOR_PROB = 0.01
cfg.MODEL.HEAD.NUM_BOTTLENECK = 1
cfg.MODEL.HEAD.NUM_DIFFMODEL = 1
cfg.MODEL.HEAD.CROSS_TEMP= False
cfg.MODEL.HEAD.DIVIDE = [0, 1, 2]

cfg.MODEL.ROI_BOX_HEAD = edict()
cfg.MODEL.ROI_BOX_HEAD.IN_FEATURES = ['p5']
cfg.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION = 7
cfg.MODEL.ROI_BOX_HEAD.POOLER_SAMPLING_RATIO =2
cfg.MODEL.ROI_BOX_HEAD.POOLER_TYPE = 'ROIAlignV2'


cfg.MODEL.DYNAMICCONV = edict()
cfg.MODEL.DYNAMICCONV.HIDDEN_DIM = 256
cfg.MODEL.DYNAMICCONV.DIM_DYNAMIC = 64
cfg.MODEL.DYNAMICCONV.NUM_DYNAMIC = 2

cfg.MODEL.LOSS = edict()
cfg.MODEL.LOSS.USE_FOCAL = True
cfg.MODEL.LOSS.USE_FED_LOSS = False
cfg.MODEL.LOSS.ALPHA  = 0.25
cfg.MODEL.LOSS.GAMMA  = 2.0
cfg.MODEL.LOSS.OTA_K = 5
cfg.MODEL.LOSS.CLASS_WEIGHT = 2.0
cfg.MODEL.LOSS.GIOU_WEIGHT = 2.0
cfg.MODEL.LOSS.L1_WEIGHT = 5.0
cfg.MODEL.LOSS.NO_OBJECT_WEIGHT = 0.1
